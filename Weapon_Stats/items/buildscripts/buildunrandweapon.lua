...
function build(directory, config, parameters, level, seed)
  ...
  --
	local damagePerShot = (config.primaryAbility.baseDps or 0) * (config.primaryAbility.fireTime or 1.0) * config.damageLevelMultiplier
	local energyPerShot = (config.primaryAbility.energyUsage or 0) * (config.primaryAbility.fireTime or 1.0)
